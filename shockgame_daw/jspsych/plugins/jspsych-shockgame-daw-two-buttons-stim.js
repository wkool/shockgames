/**
* jspsych-shockgame-daw-two-buttons-stim
...
(function($) {
	jsPsych["shockgame-daw-two-buttons-stim"] = (function() {
		...
		plugin.trial = function(display_element, trial) {
			...
			if (state_name == 'green') {
				var state_color = [0, 100, 0];
			}
			if (state_name == 'yellow') {
				var state_color = [153, 153, 0];
			}
		...
		var display_stimuli = function(stage){
			...
			if (stage==2) { // feedback
			    ...
			    $('#jspsych-shockgame-daw-bottom-stim-'+position).css('background-image', 'url(img/'+state_name+'_stim_'+stims[pos]+'_pressed.png)');
			    $('#jspsych-shockgame-daw-bottom-stim-'+other_position).css('background-image', 'url(img/'+state_name+'_stim_'+stims[other_pos]+'_deact.png)');
			}
